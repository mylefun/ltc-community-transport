...
const releaseNotes = [
  {
    ...
    date: "2026-05-30",
    items: [
      "優化即時接送地圖響應式寬度：調整最小寬度至 280px，擴大單欄堆疊斷點至 1080px，防止在大字型或窄螢幕下超出版面溢出",
      "修正地理圍欄模擬抵達座標解析：將行程與類型參數精確導入，使模擬座標與後台派單、地圖 OSRM 真實路徑解析點 100% 精準對齊",
      "限制 GPS 診斷卡片安全權限：將定位連線診斷與模擬定位卡片列為行政測試工具，僅於承辦人密碼解鎖後對管理員開放，對一般司機完全隱藏",
      "修復手機端自動接送提示通知滿版異常：優化地理圍欄自動對話框在行動裝置上的佈局結構，採用垂直居中卡片與底部併排按鈕設計",
      "精簡司機任務清單排版：將「實際已接/已送達時間」狀態調整至地址右側併排於同一行，大幅提昇窄螢幕顯示下的版面簡潔度",
    ],
  },
  {
    version: "v0.9.2",
